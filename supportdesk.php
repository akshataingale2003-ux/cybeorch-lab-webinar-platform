...
<section class="section pt-0">
  <div class="container">
    ...
    <div class="desk-features row g-4">

      <!-- Row 1, Col 1 — Ticket Categories -->
      ...
      <!-- Row 2 — Track | Priority | Assigned Team (one row) -->
      ...
      <!-- Row 3, Col 2 — Chat / Reply System -->
     <!--<div class="col-12 col-md-6">
      <div class="feature-card" id="chat">
        <div class="feature-card-head">
