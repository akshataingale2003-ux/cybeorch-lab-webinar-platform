...
$pageTitle = 'About Us – CYBEORCH LAB';
...
<meta name="description" content="CYBEORCH LAB — a real-world software development and innovation lab building practical technology solutions, industry-ready talent, and scalable digital products.">
...
@media(max-width:767px){.section{padding:3rem 0}.btn-outline-cyber{display:block;margin:.75rem 0 0}}
</style>
</head>
<body>
...
<main>
  <section class="section pt-0">
    <div class="container">
      ...
      <h2 class="section-title text-center mb-2">Why <span class="accent">CYBEORCH LAB</span>?</h2>
  ...
  <!--<section class="section pt-0 pb-5">
    <div class="container">
      <div class="cta-box">
        ...
        <p style="color:var(--cyber-muted);max-width:560px;margin:0 auto 2rem;line-height:1.8">Explore internships, bootcamps, and live projects. Register to join the CYBEORCH LAB ecosystem.</p>
