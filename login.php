...
$signupSuccessUrl = $redirectAfterLogin;
if ($signupSuccessUrl === 'dashboard.php' || $signupSuccessUrl === 'index.php' || $signupSuccessUrl === '') {
    $signupSuccessUrl = 'dashboard.php?welcome=1&registered=1';
}
