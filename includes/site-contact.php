...
/**
 * Site-wide contact channels (email) and reusable action cards.
 */
...
function siteContactChannels(): array
{
    ...
    $subject = rawurlencode('CYBEORCH LABS — Program Enquiry');
...
function renderContactActionStyles(): void
{
    ...
    echo '<style id="cybeorch-contact-actions">'
        . '.contact-method-grid{display:grid;grid-template-columns:minmax(0,1fr);gap:.75rem;max-width:320px}'
...
/**
 * @param string $selectedPref  email
