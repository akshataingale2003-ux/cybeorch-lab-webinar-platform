...
{
    return url(signupSuccessRedirectPath());
}
...
function authRegistrationPopupClientConfig(array $config): array
{
    return [
        ...
        'validateReferralUrl' => url('api/validate-referral.php'),
  ...
  <div class="auth-reg-modal-dialog auth-reg-popup-inner">
    ...
    <div class="auth-split-card auth-reg-scale-target">
      <div class="auth-split-main">
        <div class="auth-card">
          <h1 class="auth-title" id="authRegTitle">Welcome to <span class="accent">CYBEORCH LABS</span></h1>
          ...
          <form id="cybeorchRegForm" class="auth-reg-dynamic-form" novalidate
            ...
            <div class="auth-reg-form-grid" data-reg-current-step="profile">
              ...
              <div class="mb-3 auth-reg-step-panel is-active" data-reg-step="profile">
                <label class="form-label" for="regMobile">Mobile</label>
              ...
              <div class="mb-3 auth-reg-span-full auth-reg-step-panel is-active" data-reg-step="profile">
                <label class="form-label" for="regReferralCode">Referral code <span class="auth-optional-tag">(optional)</span></label>
                <input type="text" name="referral_code" id="regReferralCode" class="form-control" placeholder="Friend's referral code" maxlength="20" autocomplete="off" spellcheck="false" autocapitalize="characters" value="<?= htmlspecialchars(normalizeReferralCodeInput($refCode)) ?>">
                <p class="auth-referral-hint" id="regReferralHint">Enter a friend's code — they earn <strong>+<?= (int) NXL_REFERRAL_BONUS ?> NxL</strong> when you join.</p>
              </div>
          ...
          <div class="auth-card-footer" id="authSignupLegalFooter">
            <p class="auth-card-footer-note">By registering you agree to our <button type="button" class="auth-legal-signup-link" data-auth-legal-signup-locked="1" data-auth-legal-kind="terms" aria-disabled="true">Terms</button> and <button type="button" class="auth-legal-signup-link" data-auth-legal-signup-locked="1" data-auth-legal-kind="privacy" aria-disabled="true">Privacy Policy</button>.</p>
          </div>
        </div>
      </div>
