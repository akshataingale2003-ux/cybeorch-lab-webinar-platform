...
function getAdminFormSubmissionCategories(): array
{
    ...
    return [
        ...
        'get-started' => [
            'label'           => 'Get Started',
            'keys'            => formSubmissionKeysForCanonical('get-started'),
            'storage_tables'  => ['get_started_inquiries'],
        ],
...
function syncFormSubmissionKeysInDatabase(): void
{
    ...
    dbTry(static function () {
        $tableToKey = [
            ...
            'get_started_inquiries'   => 'get-started',
...
function getFormSubmissionRegistryDefinitions(): array
{
    return [
        ...
        ['form_key' => 'get-started', 'form_label' => 'Get Started inquiry', 'page' => 'get-started.php', 'table' => 'get_started_inquiries', 'admin' => 'admin/get-started-inquiries.php'],
