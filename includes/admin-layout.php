...
<aside class="sidebar">
  ...
  <nav class="sidebar-nav">
    ...
    <?php $link('live-projects', 'admin/live-projects.php', 'fa-code-branch', 'Live Projects'); ?>
    <?php $link('assignments', 'admin/assignments.php', 'fa-briefcase', 'Hands-on Projects'); ?>
    <?php $link('freelance-projects', 'admin/freelance-projects.php', 'fa-laptop-code', 'Freelance Projects'); ?>
    ...
    <?php $link('students', 'admin/students.php', 'fa-users', 'User Management'); ?>
    ...
    <?php $link('form-submissions', 'admin/form-submissions.php', 'fa-clipboard-list', 'All submissions', $submissionBadge); ?>
    <?php $link('messages', 'admin/messages.php', 'fa-envelope', 'Messages', $unread); ?>
    <?php $link('demo-requests', 'admin/demo-requests.php', 'fa-desktop', 'Demo requests'); ?>
    <?php
    $newGetStarted = (int) dbTry(fn () => getGetStartedInquiryCount('new'), 0);
    $link('get-started-inquiries', 'admin/get-started-inquiries.php', 'fa-rocket', 'Get Started', $newGetStarted > 0 ? $newGetStarted : null);
    ?>
    <?php $link('collaboration', 'admin/collaboration-inquiries.php', 'fa-handshake', 'Collaboration'); ?>
    <?php $link('website-registrations', 'admin/website-registrations.php', 'fa-user-plus', 'Website signups'); ?>
    ...
    if (function_exists('getAdminUnreadNotificationCount')) {
        ...
        $adminNxUnread = getAdminUnreadNotificationCount();
    }
    $link('notifications', 'admin/notifications.php', 'fa-bell', 'Notifications', $adminNxUnread > 0 ? $adminNxUnread : null);
    ?>
