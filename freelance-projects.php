...
<title><?= htmlspecialchars($pageTitle) ?><?= $isDetail ? ' – Freelance Projects' : '' ?> – CYBEORCH LABS</title>
<?php if (!$isDetail): ?>
<meta name="description" content="Browse open freelance projects at CYBEORCH LABS — remote software, design, cybersecurity, and Web3 engagements.">
<?php endif; ?>
