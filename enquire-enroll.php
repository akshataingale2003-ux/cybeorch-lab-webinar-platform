...
<meta name="description" content="Enquire and enroll in CYBEORCH LAB webinars, bootcamps, and software development company programs. Submit your details and our team will contact you.">
          ...
          <form method="POST" action="<?= url('enquire-enroll.php') ?>" id="enrollForm" novalidate>
            ...
            <div class="row g-3">
              ...
              <div class="col-12">
                ...
                <p class="form-hint">Tap a card to open your email app, phone dialer, or WhatsApp chat. Your selection is saved for our team when you submit this form.</p>
              </div>
