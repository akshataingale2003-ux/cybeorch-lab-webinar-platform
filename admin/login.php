...
<title>Admin Login – CYBEORCH LAB</title>
...
.auth-title{font-family:'Rajdhani',sans-serif;font-size:1.5rem;font-weight:700;text-align:center;margin-bottom:0.25rem;}
...
<div class="auth-container">
  ...
  <div class="auth-card">
    ...
    <div class="security-note">
      <i class="fas fa-lock me-1" style="color:var(--cyber-orange)"></i>
      All admin actions are logged. Unauthorized access is prohibited.
      <div style="margin-top:0.5rem;color:var(--cyber-accent)">Default: <strong>cybeorch_admin</strong> / <strong>Admin@123</strong></div>
    </div>
  </div>
