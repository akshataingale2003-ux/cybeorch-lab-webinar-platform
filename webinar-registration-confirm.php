...
<title>Register Free — <?= escHtml((string) $webinar['title']) ?></title>
...
<div class="wrc-wrap wrc-wrap--register">
  ...
  <div class="wrc-card">
    <header class="wrc-header">
      ...
      <div>
        <h1><?= escHtml((string) $webinar['title']) ?></h1>
        <div class="wrc-header-meta"><i class="far fa-calendar-alt"></i><span><?= escHtml($scheduledLabel) ?></span></div>
      </div>
    </header>
...
<meta charset="UTF-8">
<?php renderStandardViewport(); ?>
<title>Confirm Registration — CYBEORCH LABS</title>
<?php renderAuthPageHead(); ?>
<link rel="stylesheet" href="<?= htmlspecialchars(url('assets/css/webinar-registration.css')) ?>">
</head>
